...
$(DIR_BUILD)/overlay_contours.npz: $(DIR_SRC)/overlay_contours.py $(DIR_BUILD)/raytrace.npy $(DIR_BUILD)/overlay_contours.toml $(DIR_BUILD)/adjust_scene.toml
	@echo "Create overlay Contours"
	uv run $(DIR_SRC)/overlay_contours.py $(DIR_BUILD)/raytrace.npy  --output $@ --config-contours $(DIR_BUILD)/overlay_contours.toml --config-scene $(DIR_BUILD)/adjust_scene.toml
