...
.PHONY: setup all run run_no_overlays run_clouds_coastlines gcode clean

BLENDER_BIN ?= /Applications/Blender.app/Contents/MacOS/Blender
BLENDER_FILE := templates/template.blend
...
$(DIR_BUILD)/blender_paths.blend: $(BLENDER_FILE) $(DIR_BLENDER)/adjust_paths.py
...
$(DIR_BUILD)/blender_overlays.blend: $(DIR_BUILD)/blender_mesh.blend
	rsync -au $^ $@
...
$(DIR_BUILD)/overlay_coastlines_cropped.npz: $(DIR_BUILD)/blender_overlays.blend $(DIR_BUILD)/mesh_blender.ply $(DIR_BUILD)/overlay_coastlines.npz $(DIR_SRC)/overlay_project.py $(DIR_BLENDER)/export_overlay_lines.py $(DIR_SRC)/overlay_crop.py
...
$(DIR_BUILD)/overlay_poi_%.npz: $(POI_DIR)/% $(DIR_SRC)/overlay_pois.py $(DIR_BUILD)/blender_overlays.blend $(DIR_BUILD)/mesh_blender.ply $(DIR_SRC)/overlay_project.py $(DIR_BLENDER)/export_overlay_lines.py $(DIR_SRC)/overlay_crop.py $(DIR_BUILD)/overlay_pois.toml
...
$(DIR_BUILD)/overlay_grid_cropped.npz: $(DIR_BUILD)/blender_overlays.blend $(DIR_BUILD)/mesh_blender.ply $(DIR_BUILD)/overlay_grid.npz $(DIR_SRC)/overlay_project.py $(DIR_BLENDER)/export_overlay_lines.py $(DIR_SRC)/overlay_crop.py
...
$(DIR_BUILD)/overlay_contours_cropped.npz: $(DIR_BUILD)/blender_overlays.blend $(DIR_BUILD)/overlay_contours.npz $(DIR_BLENDER)/export_overlay_lines.py $(DIR_SRC)/overlay_crop.py
...
$(DIR_BUILD)/overlay_axis_cropped.npz: $(DIR_BUILD)/blender_overlays.blend $(DIR_BUILD)/overlay_axis.npz $(DIR_BLENDER)/export_overlay_lines.py $(DIR_SRC)/overlay_crop.py
...
$(DIR_BUILD)/overlay_clouds_front.npz: $(DIR_SRC)/hatch.py $(DIR_BUILD)/clouds_mapping_front_angle.png $(DIR_BUILD)/clouds_mapping_front_distance.png $(DIR_BUILD)/clouds_mapping_front_background.png $(DIR_BUILD)/overlay_clouds_hatch.toml
...
$(DIR_BUILD)/overlay_clouds_back.npz: $(DIR_SRC)/hatch.py $(DIR_BUILD)/clouds_mapping_back_angle.png $(DIR_BUILD)/clouds_mapping_back_distance.png $(DIR_BUILD)/clouds_mapping_back_background.png $(DIR_BUILD)/overlay_clouds_hatch.toml
