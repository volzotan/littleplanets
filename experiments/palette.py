...
if __name__ == "__main__":
    ...
    parser.add_argument("--palette-brightness-difference", type=Path, default="mapping_brightness_difference.png", help="Output filename for HSV value difference mapping [PNG]")
    ...
    def diff_h(c1, c2):
        # opencvs HSV color conversion results in an image in the range of H: [0, 179], S: [0, 255], V: [0, 255]
